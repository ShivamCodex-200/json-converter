...
import { ShieldCheck, Zap, Braces, Minimize2, RefreshCw } from 'lucide-react';
          ...
          items={[
            {
              ...
              answer: "No. Minification only removes the 'syntactic sugar' (spaces and newlines) that makes JSON readable for humans. The data content and hierarchy remain identical.",
              icon: <Minimize2 className="w-4 h-4" />
            },
            {
              question: "What is the difference between stringify and minification?",
              answer: "In JavaScript, JSON.stringify(data) without additional arguments produces a minified string. Our tool provides this same clean output instantly without needing a console.",
              icon: <Braces className="w-4 h-4" />
            },
            {
              question: "Can I un-minify it later?",
              answer: "Yes! Any standard JSON formatter or 'pretty printer' can take a minified string and restore the original indentation for human reading.",
              icon: <RefreshCw className="w-4 h-4" />
            },
            {
              question: "Is my minified data secure?",
              answer: "Yes. Since ToolCorners runs 100% in your browser, your data is never transmitted across the network during the minification process, making it safe for production keys.",
